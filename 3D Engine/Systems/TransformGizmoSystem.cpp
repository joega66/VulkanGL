...
void TransformGizmoSystem::Start(Engine& Engine)
{
	...
	const Material* MaterialX = Engine.Assets.LoadMaterial("Engine_X_Axis",
		std::make_unique<Material>(Engine.Device, EMaterialMode::Opaque, &AssetManager::Green, nullptr, nullptr, 0.0f, 0.0f));
	const Material* MaterialY = Engine.Assets.LoadMaterial("Engine_Y_Axis",
		std::make_unique<Material>(Engine.Device, EMaterialMode::Opaque, &AssetManager::Blue, nullptr, nullptr, 0.0f, 0.0f));
	const Material* MaterialZ = Engine.Assets.LoadMaterial("Engine_Z_Axis",
		std::make_unique<Material>(Engine.Device, EMaterialMode::Opaque, &AssetManager::Red, nullptr, nullptr, 0.0f, 0.0f));
